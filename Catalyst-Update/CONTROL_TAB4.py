...
ESP32_IP = "192.168.1.16"  # Change to your ESP32's IP
ESP32_BASE_URL = f"http://192.168.1.16/"
        ...
        return html.Div([
            html.Div([
                ...
                html.Div([
                    ...
                    # Right Column - Room Schedule Display
                    html.Div([
                        dbc.Card([
                            dbc.CardBody([
                                html.H4("Room Schedule", className='schedule-header'),
                                dcc.Loading(
                                    id="loading-schedule",
                                    type="default",
                                    children=html.Div(id='room-schedule-display', className='schedule-container')
                                )
                            ])
                        ], className='schedule-card')
                    ], className='right-column')
                ], className='main-content')
            ], className='tab4-container'),
