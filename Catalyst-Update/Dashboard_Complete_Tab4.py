...
ESP32_IP = "172.30.9.192"  # Change to your ESP32's IP
ESP32_BASE_URL = f"http://172.30.9.192/"
     ...
     # Add this with your other dcc.Store components
        ...
        return html.Div([
            ...
            html.Div([
                        ...
                        dbc.CardBody([
                            ...
                            html.Div([
                                ...
                                html.Div([
                                    ...
                                    html.Label("Date", style={'color': 'white', 'marginBottom': '5px'}),
                                ...
                                html.Div([
                                    ...
                                    html.Label("Room", style={'color': 'white', 'marginBottom': '5px'}),
                ...
                # Right Column: KPI + Recommendations
                ...
                html.Div([
                    ...
                    dbc.Card([
                        dbc.CardBody([
                            html.H4("💡 Recommendations", style={'color': 'white', 'textAlign': 'center'}),
